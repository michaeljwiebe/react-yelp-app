    ...
    return (
        <div className="header">
            ...
            <div className="produced">
                produced by MattLomet and Michael Wiebe and Suzann Crumbock
            </div>
        </div>
    );
}
        ...
        return (
            <div className="mainContainer" key={index}>
                <div className="businessTexts">
                    ...
                    <div className="businessPhone text">
                ...
                <div className="images">
                    ...
                    <img
                        ...
                        src={business.rating_img_url_large}
                    />
                </div>
                <form>
                    <button
